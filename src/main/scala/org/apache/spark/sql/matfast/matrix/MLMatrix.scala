...
abstract class MLMatrix extends Serializable {
  ...
  def map(f: Double => Double): MLMatrix
  ...
  def update(f: Double => Double): MLMatrix
...
private[matfast] class MatrixUDT extends UserDefinedType[MLMatrix] {
  ...
  override def serialize(obj: MLMatrix): InternalRow = {
    MLMatrixSerializer.serialize(obj)
  }

  override def deserialize(datum: Any): MLMatrix = {
    MLMatrixSerializer.deserialize(datum)
  }

  override def userClass: Class[MLMatrix] = classOf[MLMatrix]
  ...
  override def typeName: String = "MLmatrix"
...
@Since("1.0.0")
@SQLUserDefinedType(udt = classOf[MatrixUDT])
case class DenseMatrix @Since("1.3.0")(
      @Since("1.0.0") override val numRows: Int,
      @Since("1.0.0") override val numCols: Int,
      @Since("1.0.0") val values: Array[Double],
      @Since("1.3.0") override val isTransposed: Boolean) extends MLMatrix {
  ...
  override def equals(o: Any): Boolean = o match {
    case m: MLMatrix => asBreeze == m.asBreeze
    case _ => false
  }
  ...
  override def map(f: Double => Double) = new DenseMatrix(numRows, numCols, values.map(f),
    isTransposed)

  override def update(f: Double => Double): DenseMatrix = {
...
@Since("1.3.0")
@SQLUserDefinedType(udt = classOf[MatrixUDT])
case class SparseMatrix @Since("1.3.0")(
      @Since("1.2.0") override val numRows: Int,
      @Since("1.2.0") override val numCols: Int,
  ...
  override def map(f: Double => Double) =
...
object MLMatrices {
  ...
  /**
    ...
    */
  @Since("1.0.0")
  def dense(numRows: Int, numCols: Int, values: Array[Double]): MLMatrix = {
  ...
  /**
    ...
    */
  private def fromBreeze(breeze: BM[Double]): MLMatrix = {
    breeze match {
      case dm: BDM[Double] =>
  ...
  /**
    ...
    */
  @Since("1.2.0")
  def zeros(numRows: Int, numCols: Int): MLMatrix = DenseMatrix.zeros(numRows, numCols)
  ...
  /**
    ...
    */
  @Since("1.2.0")
  def ones(numRows: Int, numCols: Int): MLMatrix = DenseMatrix.ones(numRows, numCols)
  ...
  /**
    ...
    */
  @Since("1.2.0")
  def eye(n: Int): MLMatrix = DenseMatrix.eye(n)
  ...
  /**
    ...
    */
  @Since("1.3.0")
  def speye(n: Int): MLMatrix = SparseMatrix.speye(n)
  ...
  /**
    ...
    */
  @Since("1.2.0")
  def rand(numRows: Int, numCols: Int, rng: Random): MLMatrix =
  ...
  /**
    ...
    */
  @Since("1.3.0")
  def sprand(numRows: Int, numCols: Int, density: Double, rng: Random): MLMatrix =
  ...
  /**
    ...
    */
  @Since("1.2.0")
  def randn(numRows: Int, numCols: Int, rng: Random): MLMatrix =
  ...
  /**
    ...
    */
  @Since("1.3.0")
  def sprandn(numRows: Int, numCols: Int, density: Double, rng: Random): MLMatrix =
  ...
  /**
    ...
    */
  @Since("1.2.0")
  def diag(vector: Vector): MLMatrix = DenseMatrix.diag(vector)
  ...
  /**
    ...
    */
  @Since("1.3.0")
  def horzcat(matrices: Array[MLMatrix]): MLMatrix = {
    if (matrices.isEmpty) {
  ...
  /**
    ...
    */
  @Since("1.3.0")
  def vertcat(matrices: Array[MLMatrix]): MLMatrix = {
    if (matrices.isEmpty) {
  ...
  /**
    ...
    */
  @Since("2.0.0")
  def fromML(m: newlinalg.Matrix): MLMatrix = m match {
...
object MatrixImplicits {
  ...
  implicit def mllibMatrixToMLMatrix(m: MLMatrix): newlinalg.Matrix = m.asML
  ...
  implicit def mlMatrixToMLlibMatrix(m: newlinalg.Matrix): MLMatrix = MLMatrices.fromML(m)

  implicit def mlDenseMatrixToMLlibDenseMatrix(m: newlinalg.DenseMatrix): DenseMatrix =
    MLMatrices.fromML(m).asInstanceOf[DenseMatrix]

  implicit def mlSparseMatrixToMLlibSparseMatrix(m: newlinalg.SparseMatrix): SparseMatrix =
    MLMatrices.fromML(m).asInstanceOf[SparseMatrix]
}

case class MatrixBlock(rid: Int, cid: Int, matrix: MLMatrix)
