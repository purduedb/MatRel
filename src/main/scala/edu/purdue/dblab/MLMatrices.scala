...
sealed trait MLMatrix extends Serializable {
...
@DeveloperApi
private class MatrixUDT extends UserDefinedType[MLMatrix] {
...
class DenseMatrix(
                   ...
                   override val isTransposed: Boolean) extends MLMatrix {
  ...
  override def toBreeze: BM[Double] = {
    if (!isTransposed) {
